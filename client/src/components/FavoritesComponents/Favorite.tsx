...
const Favorites = () => {
  ...
  return (
    <Box sx={{width: {xs: "100%", sm: "100%", md: "80%"}, margin: "0 auto", my: 5 }}>
        ...
        <Box sx={{display: {xs: favorites.products.length > 0 ? "none" : "none", sm: favorites.products.length > 0 ? "none": "flex"}, flexDirection: "column", justifyContent: "center", alignItems: "center", jusstifySelf: "center", textAlign: "center", p: 10}}>
