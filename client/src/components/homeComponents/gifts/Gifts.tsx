...
const Gifts = () => {
    return (
        ...
        <Box sx={{display: {xs: "grid", md: "flex"}, gridTemplateColumns: {sx: "1fr", sm: "1fr 1fr"}, justifyContent: "center", alignItems: "center", margin: "0 auto", p:1, gap: "10px"}}>
            ...
            <GiftItem categoryImage={"https://audiocommand.com/images/easyblog_articles/102/b2ap3_large_how-to-enjoy-a-customized-home-entertainment-system.jpg"} categoryTitle={"Netflix and chill"} category="entertainment"/>
